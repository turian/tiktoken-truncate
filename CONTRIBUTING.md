# Contributing to Tiktoken Truncate

👏🎉 First off all, Thanks for your interest in contributing to our project! 🎉👏

The following is a set of guidelines for contributing to Tiktoken Truncate. These are
...
We use GitHub issues to track public bugs/enhancements. Report a new one by [opening a new issue](https://github.com/turian/tiktoken-truncate/issues).
...
If you have any question feel free to contact us at Github.
